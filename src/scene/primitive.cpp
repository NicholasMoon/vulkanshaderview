...
void ShaderProgram::create(LogicalDevice& logicaldevice) {
    ...
    if (fragmentShaderFile == "../shaders/light.spv") {
        descriptorsetlayout.createDescriptorSetLayout_light(logicaldevice);
    }
    else if (fragmentShaderFile == "../shaders/envMap.spv") {
        descriptorsetlayout.createDescriptorSetLayout_skybox(logicaldevice);
    }
    else {
...
void GraphicsPipeline::createGraphicsPipeline(ShaderProgram& shaderprogram, Swapchain& swapchain, LogicalDevice& logicaldevice, DescriptorSetLayout& descriptorsetlayout, RenderPass& renderpass, MSAABuffer& msaabuffer) {
    ...
    if (shaderprogram.fragmentShaderFile == "../shaders/envMap.spv") rasterizer.cullMode = VK_CULL_MODE_NONE;
